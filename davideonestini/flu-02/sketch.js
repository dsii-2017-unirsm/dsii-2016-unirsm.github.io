...
function draw() {
  ...
  for (var i = 0; i < dati.length; i++) {
    ...
    if ( mouseX >= padding + (i+1.5)*padding && mouseX <= padding + (i+1.5)*padding + p &&
    ...
    if ( mouseX >= padding + (i+1.5)*padding + p && mouseX <= padding + (i+1.5)*padding + p*2 &&
    mouseY >= 0 && mouseY <= height) {
      fill(255);
      textAlign(LEFT, TOP);
      textSize(14);
    ...
    if ( mouseX >= padding + (i+1.5)*padding + p*2 && mouseX <= padding + (i+1.5)*padding + p*3 &&
    mouseY >= 0 && mouseY <= height) {
      fill(255);
      textAlign(LEFT, TOP);
      textSize(14);
