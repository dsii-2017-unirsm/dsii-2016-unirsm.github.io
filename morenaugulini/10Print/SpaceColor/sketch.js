...
// 10 print porting to P5js - space proposta1
...
if((mouseX)<displayWidth/2 & (mouseY)<displayHeight/2) { // disegno in 4o quadrante(bassodestra)
...
var y=ceil(random(displayHeight/2, displayHeight))+r;
noFill();
...
stroke(random(255),random(255),random(255));  //colore linee random
